...
function Forecast({ weather,setWeather }) {
   const { data } = weather;
    ...
    useEffect(() => {
       console.log("ssdsds"+data.length)
    }, []);
    ...
    return (
        ...
        <div>
            ...
            <div className="temp">
                ...
                {renderTemperature(data?.temperature?.current || "loading")}
                <sup className="temp-deg" onClick={toggleTemperatureUnit}>
                    {isCelsius ? "°C" : "°F"} | {isCelsius ? "°F" : "°C"}
                </sup>
            </div>
            <p className="weather-des">{data?.condition?.description || "Loading"}</p>
